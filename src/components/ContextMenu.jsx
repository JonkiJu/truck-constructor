...
<button type="button" className="context-item" onPointerDown={e => e.stopPropagation()} onClick={handleRotate}>
...
<button type="button" className="context-item danger" onPointerDown={e => e.stopPropagation()} onClick={handleDelete}>
<span className="context-icon" aria-hidden="true">
